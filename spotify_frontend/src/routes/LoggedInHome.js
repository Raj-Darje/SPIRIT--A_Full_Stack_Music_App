...
//         if(isPaused){
//             playSound("https://res.cloudinary.com/du5jzxyyh/video/upload/v1707887069/cblxg38kiflfeuydcir2.mp3");
//             setIsPaused(false);
//         }
//         else{
//             pauseSong();
...
//           <img
//             src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/music-songs-youtube-thumbnails-design-template-f0fcb6a767bf70426fb7a5109709c4fe_screen.jpg?ts=1600929244"
//             alt="current song thumbnail"
//             className="h-14 w-14 rounded"
//           />
//           <div className="pl-4">
//             <div className="text-sm hover:underline cursor-pointer">phir milenge</div>
//             <div className="text-xs text-gray-500 hover:underline cursor-pointer">Arijit Singh</div>
//           </div>
//         </div>
//         <div className="w-1/2 h-full flex justify-center flex-col items-center">
//             <div className="flex w-1/3 justify-between items-center">
//                 {/* Controls for playing song */}
//                 <Icon icon="ph:shuffle-fill"  fontSize={20} className="cursor-pointer text-gray-500 hover:text-white"/>
//                 <Icon icon="mdi:skip-previous-outline" fontSize={37} className="cursor-pointer text-gray-500 hover:text-white" />
//                 <Icon icon= {isPaused ? "ic:baseline-play-circle" : "ic:baseline-pause-circle"} fontSize={50} className="cursor-pointer text-gray-500 hover:text-white" onClick={()=>{
//                     togglePlayPause()
//                 }} />
//                 <Icon icon="mdi:skip-next-outline" fontSize={37} className="cursor-pointer text-gray-500 hover:text-white" />
